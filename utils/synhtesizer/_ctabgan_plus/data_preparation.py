...
class DataPrep(object):
    ...
    def __init__(self, raw_df: pd.DataFrame, categorical: list, log:list, mixed:dict, general:list, non_categorical:list, integer:list):
        ...
        # Imputation Start
        # It applies a missing value imputation for all columns except the categorical columns
        ...
        # Categorical Encoding and Metadata Saving
        for column_index, column in enumerate(self.df.columns):            
            if column in self.categorical_columns:        
                ...
                self.column_types["general"].append(column_index)
        # Categorical Encoding and Metadata Saving End
