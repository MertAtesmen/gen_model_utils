...
class DataTransformer():
    ...
    def inverse_transform(self, data):
        ...
        # This step filters the data points that exceed the limits of the real distribution.
        # NOTE: If not fitted properly this step makes the model unable to generate any data instance  
        # Comment out the bellow code and use `valid_ids = list(set(all_ids))` to disable filtering.
